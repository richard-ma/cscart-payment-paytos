...
$pre_url = "https://merchant.paytos.com/CubePaymentGateway/gateway/action.PayConfigService.do";
$pre_response = json_decode(http_response($pre_url), TRUE);
$url = $pre_response['gatewayUrl'];
fn_print_r($url);
exit;
